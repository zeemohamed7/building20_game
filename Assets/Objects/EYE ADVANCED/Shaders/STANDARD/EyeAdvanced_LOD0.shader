...
void surf (Input IN, inout SurfaceOutputStandardSpecular o) {
	...
	//Limbus Darkening
	float limbalStr = (0 - (_limbus * 10.0));
	float limbalFac = saturate(irisoffsettex * (2.0-irismasktex) * (irismasktex) * (cNdotV2*1));
	float3 baseLimbal = o.Albedo*limbalStr;
	float3 invLimbalColor = float3(1-_limbalColor.r, 1-_limbalColor.g, 1-_limbalColor.b);
	o.Albedo = lerp(o.Albedo, lerp(baseLimbal, invLimbalColor*baseLimbal, _limbalColor.a), limbalFac);
